    ...
    <section class="main">
      ...
      <section class="attendance">
        <div class="attendance-list">
          <h1>Informasi Tentang Data Barang</h1>
          <table class="table">
            <thead>
              <tr>
                <th>No</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="Ubah Data Pembayaran.php?halaman=ubah pembayaran&id=<?php echo $pecah['id']?>"style ="width:auto;"class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen"></i></a>
                  <a href="Bukti Pembayaran.php?halaman=hapus pembayaran&id=<?php echo $pecah['id']?>" style ="width:auto;"class="btn btn-primary" onclick="confirm('Yakin mau hapus data?')"><i class="fa-sharp fa-solid fa-trash"></i></a>
                </td>
              </tr>
              <?php $nomor++; ?>
              <?php } ?>
          ...
          <a href="Pembuatan Bill.php" class="btn btn-primary">Tambah Data Bill</a>
          <a href="Laporan Keuangan.php" class="btn btn-primary">Laporan Keuangan</a>
          <a href="Invoice.php" class="btn btn-primary">Lihat Nota</a>
        </div>
      </section>
    </section>
  </div>
