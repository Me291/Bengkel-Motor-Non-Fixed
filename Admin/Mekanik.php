          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="Ubah Data Mekanik.php?halaman=ubah mekanik&id=<?php echo $pecah['id']?>"style ="width:auto;"class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen"></i></a>
                  <a href="Mekanik.php?halaman=hapus mekanik&id=<?php echo $pecah['id']?>" style ="width:auto;"class="btn btn-primary" onclick="confirm('Yakin mau hapus data?')"><i class="fa-sharp fa-solid fa-trash"></i></a>
                </td>
              </tr>
              <?php $nomor++; ?>
              <?php } ?>
