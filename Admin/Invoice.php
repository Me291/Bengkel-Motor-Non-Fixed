          ...
          <div class="container mb-5 mt-3">
            <div class="row d-flex align-items-baseline">
              ...
              <div class="col-xl-3 float-end">
                <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark"><iclass="fas fa-print text-primary"></i><a href="Cetak Nota.php" target="_blank" style="text-decoration: none;">Print</a></a>
                <a class="btn btn-light text-capitalize" data-mdb-ripple-color="dark"><i
                    class="far fa-file-pdf text-danger"></i><a href="Bukti Pembayaran.php" style="text-decoration: none;">Back To Home</a></a>
              </div>
              <hr>
            </div>
