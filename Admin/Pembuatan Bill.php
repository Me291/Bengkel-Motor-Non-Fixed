		...
		<div class="attendance-list">
			...
			<form action="" method="post">
				<div class="inputfield">
					...
					<input type="text" class="input" name="nama_barang" required>
				</div>
        <div class="inputfield">
          ...
          <div class="custom_select">
            <select name ="merk">
              ...
              <option value="None">None</option>
				...
				<div class="inputfield">
					<label>Jumlah</label>
					<input type="text" class="input" name="jumlah" required>
				</div> 
				<div class="inputfield">
					<label>Harga Satuan</label>
					<input type="text" class="input" name="harga" required>
				</div> 
				<button name="tambah">TAMBAH</button>
        <?php
          require 'dpembayaran.php';

          if(isset($_POST['tambah']))
          {
            if(registrasi($_POST) > 0)
            {
              echo "<script>alert('Bill baru berhasil ditambahkan!');</script>";
