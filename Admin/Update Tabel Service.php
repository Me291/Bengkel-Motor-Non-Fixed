    ...
    <section class="main">
      ...
      <section class="attendance">
        <div class="attendance-list">
          <h1>Informasi Update Kendaraan</h1>
          <table class="table">
            <thead>
              <tr>
                <th>No</th>
            ...
            <tbody>
              <?php $nomor=1;?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="Edit Table.php?halaman=ubah Tabel&id=<?php echo $pecah['id']?>"style ="width:auto;"class="btn btn-primary"><i class="fa-sharp fa-solid fa-pen"></i></a>
                    <a href="Update Tabel Service.php?halaman=hapus Tabel&id=<?php echo $pecah['id']?>" style ="width:auto;"class="btn btn-primary"><i class="fa-sharp fa-solid fa-trash"></i></a>
                  </td>
                </tr>
                <?php $nomor++; ?>
                <?php } ?>
          ...
          <a href="Tambah Data Service.php" class="btn btn-primary">Update Data Service</a>
        </div>
    </section>
  </div>
</body>
