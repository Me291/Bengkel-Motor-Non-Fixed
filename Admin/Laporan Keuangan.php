...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $delete = mysqli_query($conn,"DELETE FROM `pembayaran_konsumen` WHERE `id`= '$id'");
  echo "<script>alert('Data Berhasil Dihapus');</script>";
  echo "<meta http-equiv='refresh' content='1;url=Laporan Keuangan.php'>";
}
    ...
    <section class="main">
      ...
      <section class="attendance">
        <div class="attendance-list">
          <h1>Informasi Tentang Mekanik</h1>
          <table class="table">
            <thead>
              <tr>
                <th>No</th>
            ...
            <tbody>
              <?php $nomor=1;?>
              <?php $ambil = $conn->query("SELECT * FROM pembayaran_konsumen");?>
              ...
              <tr>
                ...
                <td><?php echo $pecah['bank_pemilik'];?></td>
                <td><?php echo $pecah['no_rekening'];?></td>
                <td><?php echo $pecah['nama_penerima'];?></td>
                <td><?php echo $pecah['nomor_tujuan'];?></td>
                <td><?php echo $pecah['bank_tujuan'];?></td>
                <td><?php echo $pecah['jumlah'];?></td>
                <td>
                  <a href="Laporan Keuangan.php?halaman=hapus pembayaran&id=<?php echo $pecah['id']?>" style ="width:auto;"class="btn btn-primary" onclick="confirm('Yakin mau hapus data?')"><i class="fa-sharp fa-solid fa-trash"></i></a>
                </td>
              </tr>
              <?php $nomor++; ?>
              <?php } ?>
