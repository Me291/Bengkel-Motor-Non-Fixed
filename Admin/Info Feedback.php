...
if (isset($_GET['id'])) {
  ...
  echo "<script>alert('Data Berhasil Dihapus');</script>";
	echo "<meta http-equiv='refresh' content='1;url=Info Feedback.php'>";
}
      ...
      <section class="attendance">
        <div class="attendance-list">
          ...
          <table class="table">
            ...
            <tbody>
            <?php $nomor=1;?>
              <?php $ambil = $conn->query("SELECT * FROM feedback");?>
              ...
              <tr>
                ...
                <td>
                  <a href="Info Feedback.php?halaman=hapus feedback&id=<?php echo $pecah['id']?>"style ="width:auto;"class="btn btn-primary" ><i class="fa-sharp fa-solid fa-trash"></i></a>
                </td>
              </tr>
              <?php $nomor++; ?>
              <?php } ?>
